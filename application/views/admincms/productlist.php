        ...
        <div class="col-md-10" style="margin:0!important">
            ...
            <div class="title clearfix">
              ...
              <div class="col-md-6 tr">
                <a href="<?php echo base_url('admincms/productadd');?>" class="btn btn-info">Create Product Credit</a>
                </div>
              </div>
            </div>
            <div class="content">
                        ...
                        <table id="DataTable" class="table table-striped" cellpadding="0" cellspacing="0" width="100%">
                            ...
                            foreach($content as $c){ ?>
                                <tr>
									...
									<td><?php echo $c['menu']; ?></td>
									<td><img width="60" src="<?php echo $c['images'];?>"></td>
                                  ...
                                  <?php
                                    ...
                                    <td class="text-center">
                                        <a href="#" data-href="<?php echo base_url(); ?>admincms/productedit/<?php echo $c['id_post']; ?>" data-toggle="modal" data-target="#confirm-edit">
                                            <span class="btn btn-info" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-edit"></i></span>
                                        </a>
                                        <a href="#" data-href="<?php echo base_url(); ?>product/delete/<?php echo $c['id_post']; ?>" data-toggle="modal" data-target="#confirm-delete">

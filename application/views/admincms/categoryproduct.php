									   ...
									   <?php $no=1; foreach($label as $cat){;?>
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="<?php echo base_url(); ?>admincms/editcategoryproduct/<?php echo $cat['id'];?>">
                                                      <span class="btn btn-info" data-toggle="tooltip" data-placement="top" title="Edit">
                                                        <i class="fa fa-edit"></i>
                                                      </span>
                                                    </a>
                                                    <a href="#" data-toggle="modal" data-target="#confirm-delete" data-href="<?php echo base_url(); ?>categoryproduct/delete/<?php echo $cat['id'];?>">
...
<script type="text/javascript">
  $(document).ready(function(){
      $('form#category').on('submit', function (e) {
        ...
        $('#loader').show();
         $.ajax({
             url: "<?php echo base_url('categoryproduct/save'); ?>",
             type: "POST",

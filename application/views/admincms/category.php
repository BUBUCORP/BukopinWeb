                                    ...
                                    <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="<?php echo base_url(); ?>admincms/editcategory/<?php echo $cat['id'];?>">
                                                      <span class="btn btn-info" data-toggle="tooltip" data-placement="top" title="Edit">
                                                        <i class="fa fa-edit"></i>
                                                      </span>
                                                    </a>
                                                    <a href="#" data-toggle="modal" data-target="#confirm-delete" data-href="<?php echo base_url(); ?>category/delete/<?php echo $cat['id'];?>">

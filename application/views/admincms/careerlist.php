        ...
        <div class="col-md-10" style="margin:0!important">
            ...
            <div class="title clearfix">
              ...
              <div class="col-md-6 tr">
                <a href="<?php echo base_url('admincms/career');?>" class="btn btn-info">Create Post Career</a>
                </div>
              </div>
            </div>
            <div class="content">
                            ...
                            foreach($content as $c){ ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="#" data-href="<?php echo base_url(); ?>admincms/careeredit/<?php echo $c['id_post']; ?>" data-toggle="modal" data-target="#confirm-edit">
                                            <span class="btn btn-info" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-edit"></i></span>
                                        </a>
                                        <a href="#" data-href="<?php echo base_url(); ?>career/delete/<?php echo $c['id_post']; ?>" data-toggle="modal" data-target="#confirm-delete">

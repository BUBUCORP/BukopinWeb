 ...
 */
$config['site_title']                 = "dinartdesign.com";       // Site Title, example.com
$config['admin_email']                = "dinar@dinartdesign.com"; // Admin Email, admin@example.com
$config['default_group']              = 'members';           // Default group, use name
$config['admin_group']                = 'adminmaster';      // Default administrators group, use name
...
/*
 ...
 | Default: auth/
 */
$config['email_templates'] = 'admincms/email/';
